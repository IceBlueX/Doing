...
QT_MOC_LITERAL(3, 17, 11), // "inputDouble"
QT_MOC_LITERAL(4, 29, 16), // "on_start_clicked"
QT_MOC_LITERAL(5, 46, 15), // "on_stop_clicked"
QT_MOC_LITERAL(6, 62, 15), // "on_show_clicked"
QT_MOC_LITERAL(7, 78, 8) // "backmain"

    },
    "Info\0sendsignal\0\0inputDouble\0"
    "on_start_clicked\0on_stop_clicked\0"
    "on_show_clicked\0backmain"
};
...
void Info::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Info::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Info::sendsignal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Info::sendsignal(QString _t1)
{
